...
public class NewGameFrame extends JFrame implements ActionListener,MouseListener,KeyListener {
	...
	private void initGUI() {
		...
		Colors[0] = new MyColor(Color.RED,        "red",       385, 410, 25, 25, KeyEvent.VK_R);
		Colors[1] = new MyColor(BROWN,			  "brown",     410, 410, 25, 25, KeyEvent.VK_P);
		...
		Colors[7] = new MyColor(VIOLET,			  "violet",    460, 435, 25, 25, KeyEvent.VK_P);
		Colors[8] = new MyColor(Color.MAGENTA,    "magenta",   385, 460, 25, 25, KeyEvent.VK_M);
		Colors[9] = new MyColor(Color.BLACK,      "black",     410, 460, 25, 25, KeyEvent.VK_K);
		Colors[10] = new MyColor(Color.DARK_GRAY, "darkgray",  435, 460, 25, 25, KeyEvent.VK_D);
		Colors[11] = new MyColor(Color.WHITE,     "white",     460, 460, 25, 25, KeyEvent.VK_W);
...
//			  destination		source
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==chooseMap) {
			...
			//reset public static variables in AIDomination
			/*RiskGame.indcontinentpriority=0;
			RiskGame.indplacearmies=0;
			RiskGame.inddefencefortification=0;
			RiskGame.continentpriority=new int[RiskGame.MAX_PLAYERS][100];
			RiskGame.countrypriority=new ArrayList<List<Integer>>();*/
			AIDomination.threats=new double[255];
			//AIDomination.borderids=new int[RiskGame.MAX_PLAYERS][130];
			AIDomination.I=new int[RiskGame.MAX_PLAYERS];
			AIDomination.J=new int[RiskGame.MAX_PLAYERS];
			AIDomination.K=new int[RiskGame.MAX_PLAYERS];
			AIDomination.multiattackers=new HashSet<>();
			/*AIDomination.results=new HashSet<String>();
			AIDomination.resultsum=0;
			AIDomination.smallmap=-1;*/
			Risk.indfortify=0;
